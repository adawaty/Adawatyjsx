    ...
    _jsxDEV(DayPicker, {
      ...
      components: {
        ...
        Chevron: ({ className, orientation, ...props }) => {
          if (orientation === "left") {
            return (
              _jsxDEV(ChevronLeftIcon, { className: cn("size-4", className), ...props,}, void 0, false, {fileName: _jsxFileName, lineNumber: 144}, this )
            )
          }
          ...
          if (orientation === "right") {
            return (
              _jsxDEV(ChevronRightIcon, {
                ...
                ...props,}, void 0, false, {fileName: _jsxFileName, lineNumber: 150}, this
              )
            )
          }

          return (
            _jsxDEV(ChevronDownIcon, { className: cn("size-4", className), ...props,}, void 0, false, {fileName: _jsxFileName, lineNumber: 158}, this )
          )
        },
...
function CalendarDayButton({
  ...
  return (
    _jsxDEV(Button, {
      ...
      ...props,}, void 0, false, {fileName: _jsxFileName, lineNumber: 192}, this
    )
  )
}
